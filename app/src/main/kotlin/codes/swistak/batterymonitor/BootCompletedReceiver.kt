...
class BootCompletedReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent?) {
        ...
        val spMain = context.getSharedPreferences(SettingsFragment.SP_MAIN_FILE, 0)
        val spService = context.getSharedPreferences(SettingsFragment.SP_SERVICE_FILE, 0)

        val startPref: String =
            settings.getString(SettingsFragment.KEY_AUTOSTART, "auto")!!
